...
# If i pass [ARGS='--network sepolia'] then i will use the sepolia network
...
deploy-sepolia:
	forge script script/DeployFundMe.s.sol:DeployFundMe --broadcast --rpc-url $(SEPOLIA_RPC_URL) --private-key $(PRIVATE_KEY) --verify --etherscan-api-key $(ETHERSCAN_API_KEY)
